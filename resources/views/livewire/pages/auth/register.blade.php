...
<div>
    <h2 class="text-2xl font-bold text-gray-800 text-center mb-6">{{ __('auth.create_account_title') }}</h2>

    <form wire:submit="register">
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('auth.name')" class="text-gray-700 font-semibold" />
        ...
        <div class="text-center mt-6 text-sm">
            <span class="text-gray-600">{{ __('auth.already_have_account') }}</span>
